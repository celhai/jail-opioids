...
for (i in 1:10){
  ...
  for (j in 1:10) {
    print(j)
    vec = c(vec,model(5100000, 5000000, 100000, 0, 0, 1/14, .01, .01, .0001*(80+j)*i, .0001*i, .001, .001, .01))
  ...
  ggplot(longData, aes(x = round(80+Var1,10), y = round(.0001*Var2,10))) + 
  geom_raster(aes(fill=value)) + 
  scale_fill_gradient(low="grey90", high="red") +
  labs(x="βOW/βWD", y="βWD", title="Heatmap") +
